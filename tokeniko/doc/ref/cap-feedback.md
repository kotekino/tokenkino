...
1. Yesterday, talking with him, I noticed that tokeniko has difficulties with a simple task: he knows he is a software (many KB items say so), he knows he is a mind. But if I ask "what are you" he can't answer. Is the "what" the problem? Where do you think the problem is?
