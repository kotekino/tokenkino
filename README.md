# README.md — the end goal of tokeniko

> This is the north star of the project: *why* tokeniko exists. 
...
| 5 | **Reasoning / inconsistency** — detect logical contradictions; report the premise + identification set | 🚧 | `e_statement.py` (`INCONSISTENT` path) — design in `doc/ref/notes.md` |
